...
function AdminPanel() {
  ...
  return (
    <div style={{ fontFamily: 'system-ui, -apple-system, sans-serif', maxWidth: 480, margin: '0 auto', paddingBottom: 40 }}>
      ...
      <div style={{ background: theme.heroGradient, padding: '22px 20px 20px', color: '#fff' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
          <div>
            ...
            <p style={{ margin: 0, fontSize: 12, color: 'rgba(255,255,255,0.6)' }}>Platform Control Center</p>
          </div>
      ...
      {/* Tab scroll */}
      <div style={{ display: 'flex', gap: 6, padding: '12px 16px', overflowX: 'auto', background: '#fff', borderBottom: `1px solid ${theme.border}`, position: 'sticky', top: 0, zIndex: 50 }}>
        {TABS.map(t => (
          <button key={t.key} onClick={() => setTab(t.key)} style={{
            flexShrink: 0, padding: '6px 12px', borderRadius: 18, fontSize: 11.5, fontWeight: 700,
